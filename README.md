[![MATLAB](https://github.com/julienbilleter/ci-configuration-examples/actions/workflows/
ci.yml/badge.svg)](https://github.com/julienbilleter/ci-configuration-examples/actions/
workflows/ci.yml)
